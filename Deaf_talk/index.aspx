                        ...
                        <div class="col-xl-7 col-md-7">
                            <div class="header_right d-flex">
                                    <div class="short_contact_list">
                                            <ul>
                                                <li><a href="#"> <i class="fa fa-envelope"></i> Faizibhatti102@gmail.com</a></li>
                                                <li><a href="#"> <i class="fa fa-phone"></i> +923417377902</a></li>
                                            </ul>
                                        </div>
                    ...
                    <div class="header_bottom_border">
                        <div class="row align-items-center">
                            <div class="col-xl-3 col-lg-2">
                                <div class="logo">
                                    <a href="index.html">
                                        <img src="img/app_logo.png" style="width:90px; height:80px;" alt="">
                                    </a>
                                </div>
                            </div>
